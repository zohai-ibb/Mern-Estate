  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col'>
        ...
        <button disabled={loading} className='mt-1 bg-slate-700 text-white rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-80'>{loading ? "Loading..." : "Update"}</button>
        <Link className="bg-green-700 text-white p-3 text-center rounded-lg hover:opacity-95 mt-1 uppercase" to={"/create-listing"}>Create Listing</Link>
      </form>
